...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (firstName && lastName && email && yourMessage) {
      ...
      setEmail("");
      setYourMessage("");
      alert("Your Message, Successfully Sent, Please Wait For Admin Reply.");
    } else {
            ...
            return (
              ...
              >
                <div className="row col-12 col-md-12 col-sm-12">
                  ...
                  <p style={{ fontSize: 20 }}>
                    <b> Your Message </b> : {data.yourMessage}
                  </p>
                  <p style={{ fontSize: 25 }}>
                    {" "}
                    <b style={{ color: "red" }}> Admin Reply : </b>{" "}
                    {data.adminReply || "Please Waiting for admin reply..."}{" "}
                  </p>
                </div>
                <button
